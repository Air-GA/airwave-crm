                        ...
                        <div className="rounded-md border p-4">
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">Atlanta, GA • Chrome on Windows</p>
                            </div>
                            <Badge>Active</Badge>
                          </div>
                        </div>
                        <Button size="sm" variant="outline">Log Out All Other Sessions</Button>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between p-2 rounded-md hover:bg-muted/50">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">Invoice #12344</p>
                          </div>
                          <div className="text-right">
                            <p className="font-medium">$49.99</p>
                            <Badge variant="outline" className="text-xs">Paid</Badge>
                        ...
                        <div className="flex items-center justify-between p-2 rounded-md hover:bg-muted/50">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">Invoice #12343</p>
                          </div>
                          <div className="text-right">
                            <p className="font-medium">$49.99</p>
                            <Badge variant="outline" className="text-xs">Paid</Badge>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Used for location-based services and routing
                                </p>
                              </div>
                            </div>
                            <FormField
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Send text notifications to customers and technicians
                                </p>
                              </div>
                            </div>
                            <FormField
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Sync pricebook and other data with Profit Rhino
                                </p>
                              </div>
                            </div>
                            <FormField
